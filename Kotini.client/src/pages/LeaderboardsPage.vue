    ...
    <div class="row d-flex justify-content-around">
      <div class="col-lg-3 mx-3 my-2 border-oj p-lg-5">
        ...
        <div class="row" v-for="l in leaders" :key="l.id">
          <div class="col-12 d-flex justify-content-between align-items-center orange-words my-3">
            <h4 class="m-0">
              <img :src="l.picture" height="40" width="40" class="rounded-circle" /> {{ l.name }}
            </h4>
            <p class="m-0">
              <b>{{ l.gamesPlayed }}</b>
            </p>
      ...
      <div class="col-lg-3 mx-3 my-2 border-oj p-lg-5">
        ...
        <div class="row" v-for="w in winLeaders" :key="w.id">
          <div class="col-12 d-flex justify-content-between align-items-center orange-words my-3">
            <h4 class="m-0">
              <img :src="w.picture" height="40" width="40" class="rounded-circle" /> {{ w.name }}
            </h4>
            <p class="m-0">
              <b>{{ w.gamesWon }}</b>
            </p>
      ...
      <div class="col-lg-3 mx-3 my-2 border-oj p-lg-5">
        ...
        <div class="row" v-for="t in timeLeaders" :key="t.id">
          <div class="col-12 d-flex justify-content-between align-items-center orange-words my-3">
            <h4 class="m-0">
              <img :src="t.picture" height="40" width="40" class="rounded-circle" /> {{ t.name }}
            </h4>
            <p class="m-0">
