let fs,path,BaseController,logger;_8ce‍.x([["Paths",()=>Paths],["RegisterControllers",()=>RegisterControllers],["RegisterSocketHandlers",()=>RegisterSocketHandlers],["attachHandlers",()=>attachHandlers]]);_8ce‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_8ce‍.w("path",[["default",["path"],function(v){path=v}]]);_8ce‍.w("./server/utils/BaseController",[["default",["BaseController"],function(v){BaseController=v}]]);_8ce‍.w("./server/utils/Logger",[["logger",["logger"],function(v){logger=v}]]);
  ...
  async function loadController(controllerName) {
    try {
      ...
      const fileHandler = await _8ce‍.i(Paths.Controllers + '/' + controllerName)
...
const HANDLERS = []
  ...
  handlers.forEach(async(handlerName) => {
    try {
      ...
      const fileHandler = await _8ce‍.i(directory + '/' + handlerName)
